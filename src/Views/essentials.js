...
function Essentials(){
    ...
    var essentials = useStore(state => state.essentials);
    ...
    var count = Math.ceil(essentials.length / perPage);
    ...
    const slice = essentials.slice(offset,offset + perPage);
        ...
        <div>
            <div style={{paddingBottom:"30px"}}>
                ...
                <Breadcrumbs aria-label="breadcrumb">
                    ...
                    <Typography className="crumbs">Essentials</Typography>
                </Breadcrumbs>
                </div>
                </div>
            </div>
