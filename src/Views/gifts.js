...
function Gifts(){
    ...
    var gifts = useStore(state => state.gifts);
    ...
    var count = Math.ceil(gifts.length / perPage);
    ...
    const slice = gifts.slice(offset,offset + perPage);
    ...
    const getId = async(data,type)=>{
        try{
            ...
            if(type == "cart"){
                ...
                await axios.post('https://child-shopping-backend.herokuapp.comproduct/addToLiked?name='+data.name,{
                    liked: data
                });
            }
        ...
        <div>
            <div style={{paddingBottom:"30px"}}>
                ...
                <Breadcrumbs aria-label="breadcrumb">
                    ...
                    <Typography className="crumbs">Gifts</Typography>
                </Breadcrumbs>
                </div>
                </div>
            </div>
