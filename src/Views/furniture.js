...
function Furniture(){
    ...
    var furniture = useStore(state => state.furniture);
    ...
    var count = Math.ceil(furniture.length / perPage);
    ...
    const slice = furniture.slice(offset,offset + perPage);
    ...
    const getId = async(data,type)=>{
        try{
            ...
            if(type == "cart"){
                await axios.post('http://localhost:5000/product/addToCart?name='+data.name,{
                    cart: data
                });    
            }
            else {
                await axios.post('http://localhost:5000/product/addToLiked?name='+data.name,{
                    liked: data
                });
            }
        ...
        <div>
            <div style={{paddingBottom:"30px"}}>
                ...
                <Breadcrumbs aria-label="breadcrumb">
                    ...
                    <Typography className="crumbs">Furniture</Typography>
                </Breadcrumbs>
                </div>
                </div>
            </div>
