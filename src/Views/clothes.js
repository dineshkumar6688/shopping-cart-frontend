...
function Clothes(){
    ...
    var clothes = useStore(state => state.clothes);
    ...
    var count = Math.ceil(clothes.length / perPage);
    ...
    const slice=clothes.slice(offset,offset + perPage);
        ...
        <div>
            <div style={{paddingBottom:"30px"}}>
                ...
                <Breadcrumbs aria-label="breadcrumb">
                    ...
                    <Typography className="crumbs">Clothes</Typography>
                </Breadcrumbs>
                </div>
                </div>
            </div>
